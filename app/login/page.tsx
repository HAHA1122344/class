...
export default function LoginPage() {
  ...
  if (!mounted) {
    return <div className="min-h-[100dvh] w-full bg-[#050510]" />;
  }
      ...
      >
        <div className="rounded-2xl bg-white/[0.02] border border-white/[0.08] backdrop-blur-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-bold text-white mb-1">欢迎回来</h1>
            <p className="text-sm text-white/30">登录你的 AI 课程账号</p>
          </div>
